...
def advertiser(ADV: str, Modelo: str):
	if(Modelo == "top_ctr"):
		resultados = pd.read_csv('resultados_top_ctr.csv', header = 0)
	
	elif(Modelo == "top_product"):
		resultados = resultados = pd.read_csv('resultados_top_product.csv', header = 0)
...
def root():
	...
	resultados_totales_top_ctr = pd.read_csv('resultados_totales_top_ctr.csv', header = 0)
	resultados_totales_top_product = pd.read_csv('resultados_totales_top_product.csv', header = 0)
...
def advertiser(ADV: str):
	...
	# TopCTR
	resultados_top_ctr = pd.read_csv('resultados_totales_top_ctr.csv', header = 0)
	resultados_top_ctr = resultados_top_ctr[(resultados_top_ctr['advertiser_id'] == ADV)]
	
	# TopProduct
	resultados_top_product = pd.read_csv('resultados_totales_top_product.csv', header = 0)
